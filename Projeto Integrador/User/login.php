...
<body>
    <div class="container">
        <h2>Login</h2>
        <form action="#" onsubmit="return verifyLogin()" method="post">
            <div class="form-group">
                <label for="cpf">CPF</label>
                <input onkeydown="formatarCPF(event)" maxlength="14" type="text" id="cpf" name="cpf" placeholder="CPF (XXX.XXX.XXX-XX)" required>
            </div>
            <div class="form-group">
